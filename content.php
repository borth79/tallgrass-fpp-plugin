...
<div class="container">
    ...
    <form method="post" action="/plugin.php?plugin=tallgrass-fpp-plugin&page=content.php">
        ...
        <div class="form-check">
            ...
            <input type="checkbox" class="form-check-input" name="persistentProjector" id="persistentProjector" aria-describedby="persistentProjectorHelp" value="1" checked="<?=false?>">
